...
class d_reader extends WP_Widget {
	...
	function __construct(){
		parent::__construct( 'd_reader', 'Yusi-活跃读者', array( 'classname' => 'd_reader' ) );
	}
	...
	function widget( $args, $instance ) {
		...
		$outer   = isset($instance['outer']) ? $instance['outer'] : '';
		$timer   = isset($instance['timer']) ? $instance['timer'] : '';

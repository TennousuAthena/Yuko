...
<div class="wrap d_wrap">
	...
	echo $themename;
	?>设置
        <span class="d_themedesc">正版来源：<a href="https://yusi123.com/" target="_blank">欲思博客</a> &nbsp;&nbsp; <a href="http://yusi123.com/3233.html" target="_blank">去下载<?php 
	echo $themename;
	?>最新版</a></span>
    </h2>
...
<form method="post" class="d_formwrap">
 ...
 <tr>
	...
	?>>开启百度分享
  	    ...
  	    腾讯微博 Appkey：<input style="width:100px;" name="t_appkey_tqq" id="t_appkey_tqq" type="text" value="<?php 
	if (dopt('t_appkey_tqq')) {
		echo dopt('t_appkey_tqq');
	} else {
		echo '801497376';
	}
	?>">

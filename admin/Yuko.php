...
function mytheme_add_admin()
{
    ...
    if ($_GET['page'] == basename(__FILE__)) {
        if ('save' == $_REQUEST['action']) {
            ...
            header("Location: admin.php?page=Yuko.php&saved=true");
            die;
        }
    }
    ...
    <div class="wrap d_wrap">
        ...
        <form method="post" class="d_formwrap">
            <table>
                ...
                <tr>
                    <td class="d_tit">网站备案号</td>
                    <td>
                        <label class="checkbox inline">
                             <input name="d_beian" id="d_beian" type="text" value="<?php dopt('d_beian', 1); ?>"> e.g.萌ICP备10000000号-1
                            &nbsp; &nbsp;
                        </label>
                    </td>
                </tr>
                <tr>
                    <td class="d_tit">用户默认头像URL</td>
                    <td>
                        <input class="ipt-b" type="text" id="d_default_avatar" name="d_default_avatar" value="<?php
                        echo dopt('d_default_avatar');
                        ?>">
                    </td>
                </tr>
                <tr>
            ...
            <textarea name="d_tui" id="d_tui" type="textarea" rows=""><?php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        提醒用户更新浏览器
                        <label class="checkbox inline">
                            <input type="checkbox" id="d_disable_browser_update" name="d_disable_browser_update" <?php
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if (dopt('t_appkey_tsina')) {
                            echo dopt('t_appkey_tsina');
                        } else {
                            echo '3036462609';
                        }
                        ?>">
                        <span class="d_tip">Appkey 自己去微博开放平台获取</span>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="d_tit">Telegram</td>
                    <td>
                        <label class="checkbox inline">
                            <input type="checkbox" id="d_tg_b" name="d_tg_b" <?php
                            if (dopt('d_tg_b')) {
                                echo 'checked="checked"';
                            }
                            ?>>开启
                        </label>
                        网址：<input class="d_inp_short" name="d_tg" id="d_tg" type="text" value="<?php
                        echo dopt('d_tg');
                        ?>">
                    </td>
                </tr>
